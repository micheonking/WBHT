...
public class Publicity extends ContentPanel implements InterfaceGridOperate{
...
//		Margins totalHBarMargins = new Margins(20, 0, 5, 30);
		...
		gridVBox.add(StartPage.getTextContents("홍보자료"),new BoxLayoutData(getTextMargins));
