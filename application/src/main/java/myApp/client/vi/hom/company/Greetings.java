...
public class Greetings extends ContentPanel {
	...
	public interface SimpleHTMLTemplate extends XTemplates {
		@XTemplate(source="HTMLGreetings.html") 
...
//	public CeoGreeting1() {
		...
		gridVBox.add(StartPage.getTextContents("인사말"), new BoxLayoutData(getTextMargins));
