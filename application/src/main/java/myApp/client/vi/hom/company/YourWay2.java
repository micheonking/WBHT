...
public class YourWay2 extends ContentPanel {
	...
	public interface SimpleHTMLTemplate extends XTemplates {
		@XTemplate(source="HTMLYourWay2.html") 
...
//	public YourWay() {
		...
		gridVBox.add(StartPage.getTextContents("찾아오시는 길"), new BoxLayoutData(getTextMargins));
