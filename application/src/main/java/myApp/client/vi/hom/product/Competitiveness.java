...
public class Competitiveness extends ContentPanel {
	...
	public interface SimpleHTMLTemplate extends XTemplates {
		@XTemplate(source="HTMLCompetitiveness.html") 
...
//	public CeoGreeting1() {
		...
		gridVBox.add(StartPage.getTextContents("제품경쟁력"), new BoxLayoutData(getTextMargins));
