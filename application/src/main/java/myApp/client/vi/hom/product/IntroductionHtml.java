...
public class IntroductionHtml extends ContentPanel {

	public interface HTMLTemplate extends XTemplates {
		//웹에디터 HTML 설정
		@XTemplate(source="introduction.html")
		SafeHtml getTemplate();
	}
	
	public IntroductionHtml() {
...
//		Info.display("",""+StartPage.CURRENTHEIGHT);
		...
		gridVBox.add(StartPage.getTextContents("제품소개"),new BoxLayoutData(getTextMargins));
