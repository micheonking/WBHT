...
public class Patent extends ContentPanel {
	...
	public interface SimpleHTMLTemplate extends XTemplates {
		@XTemplate(source="HTMLPatent.html") 
...
//	public CeoGreeting1() {
		...
		gridVBox.add(StartPage.getTextContents("특허·지적재산권"), new BoxLayoutData(getTextMargins));
