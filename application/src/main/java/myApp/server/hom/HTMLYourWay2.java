...
public class HTMLYourWay2 implements javax.servlet.Servlet {
	...
	private String getHtml() {
		...
		String content = "<font color='#606060' >"
				+	"<span style=\"font-weight:bold;font-size:1.2em;\">R&D센터 : </span>"
				+	"<span style=\"font-weight:normal;font-size:0.9em;\">"
				+	"경기도 고양시 덕양구 통일로 140 삼송테크노밸리 BB166호 "
				+	"</span>"
				;
		
		String map = "<font color='#606060' >"
					+	"<br>"
					+	"<div><img style='border:2px double silver;' src='img/yourway2.png' ><br><br></div>"
...
//		String footer1 = "<img src='img/subway_icon.jpg'>";
		...
		String footer3 = "<span style=\"font-size:0.8em;\">Tel.02-388-0701 Fax.02-388-0706</span>";
